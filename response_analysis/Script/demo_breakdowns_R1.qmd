...
```{r}
# load BGD data 
bgd <- read_csv(here("response_analysis/potential_panelists/bgd_ideal_survey_panelists.csv"),
...
# load IND data 
ind <- read_csv(here("response_analysis/potential_panelists/ind_ideal_survey_panelists.csv"),
                show_col_types = FALSE)
...
generate_plot(plot_data_bgd, "BGD", "climate_problem", "R1")
```
